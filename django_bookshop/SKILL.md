...
description: Project-specific workflow for the django_bookshop Django BookShop application. Use when changing its Django/DRF routes, authentication templates, Redis caches and invalidation signals, Celery tasks or Beat schedules, Gunicorn/NGINX/Sentry deployment, Docker Compose services, or related tests.
---
